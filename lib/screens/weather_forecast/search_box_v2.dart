...
import 'package:weatherscape/controllers/suggestion_controller.dart';
import 'package:weatherscape/screens/weather_forecast/search_box_autocomplete.dart';
...
class _SearchRowState extends ConsumerState<SearchBoxV2> {
  ...
  _buildSearchBoxAppBar() {
    return SearchBoxAutoComplete(
      controller: cityEditController,
      suggestionDelegate: fetchSuggestions(cityEditController.text),
